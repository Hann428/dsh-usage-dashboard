...
- Show account balance from the official balance endpoint.
- Show official peak/off-peak pricing and the next price-window countdown.
- Keep API-key access on the host side.
