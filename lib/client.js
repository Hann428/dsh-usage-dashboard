		...
		*/
		...
		function UsagePanel() {
			...
			return (0, react.createElement)("div", { style: box }, (0, react.createElement)("div", { style: {
				...
				fontWeight: 600,
				fontSize: "14px"
			} }, "DeepSeek 用量"), (0, react.createElement)("span", { style: headerActionsStyle }, healthDot(data.health, data.ts, now), (0, react.createElement)("a", {
				...
				flexDirection: "column",
				gap: "4px"
			} }, row("账户可用", data.balance.is_available ? "是" : "否"), pricingRows(data.pricing, now), ...data.balance.balance_infos.map((info) => (0, react.createElement)("div", {
				key: info.currency,
				style: {
		...
		function healthDot(health, updatedAt, now) {
